...
const Section3 = () => {
  return (
    <section className="section-3">
      ...
      <div className="section-3-780">
        <img src={AboutMid} alt="base_image" />
        <div className="experience-label-780">
          <h2>30</h2>
          <p>
            Years of
            <br />
      ...
      <div className="section-3-right">
        ...
        <ul>
          <li>
            <i class="fa-solid fa-check"></i>Refresing to get such a personal
            touch.
          </li>
          <li>
          ...
          <li>
            <i class="fa-solid fa-check"></i>Velit esse cillum dolore eu fugiat
            nulla pariatur.
          </li>
        </ul>
